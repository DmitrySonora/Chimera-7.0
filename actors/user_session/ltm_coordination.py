...
import uuid
from config.settings import LTM_EMOTIONAL_THRESHOLD, LTM_EMOTIONAL_PEAK_THRESHOLD, LTM_DEFAULT_SEARCH_TYPE, LTM_EMOTIONAL_SEARCH_THRESHOLD
from config.prompts import LTM_TRIGGER_KEYWORDS, LTM_TRIGGER_PRIORITIES, LTM_CATEGORY_TO_SEARCH_TYPE
